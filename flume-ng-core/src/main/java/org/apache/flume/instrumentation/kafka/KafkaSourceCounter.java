...
public class KafkaSourceCounter extends SourceCounter implements  KafkaSourceCounterMBean {
  ...
  private static final String COUNTER_KAFKA_COMMITS =
      "source.kafka.commits.count";

  private static final String COUNTER_DIRTY_READ =
      "source.kafka.dirtyread.count";

  private static final String[] ATTRIBUTES =
      {TIMER_KAFKA_COMMIT, TIMER_KAFKA_EVENT_GET,
          COUNTER_KAFKA_EMPTY, COUNTER_KAFKA_COMMITS,
          COUNTER_DIRTY_READ};
  ...
  public long incrementKafkaCommitsCount() {
    return increment(COUNTER_KAFKA_COMMITS);
  }


  public long incrementKafkaDirtyReadCount() {
    return increment(COUNTER_DIRTY_READ);
  }
  ...
  public long getKafkaCommitCounter() {
    return get(COUNTER_KAFKA_COMMITS);
  }
  ...
  public long getKafkaDirtyReadCount() {
    return get(COUNTER_DIRTY_READ);
  }
