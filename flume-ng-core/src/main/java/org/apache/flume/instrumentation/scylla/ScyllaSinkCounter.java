 ...
 */
package org.apache.flume.instrumentation.scylla;

import org.apache.flume.instrumentation.SinkCounter;

public class ScyllaSinkCounter extends SinkCounter implements ScyllaSinkCounterMBean {

    private static final String DESERIALIZATION_ERROR_COUNT =
            "sink.scylla.deserialization.error.count";

    private static final String PROCESSING_ERROR_COUNT =
            "sink.scylla.processing.error.count";

    private static final String TX_ERROR_COUNT =
            "sink.scylla.tx.error.count";

    private static final String TX_TIME_SPENT =
            "sink.scylla.tx.timespent";

    private static final String TX_SUCCESS_COUNT =
            "sink.scylla.tx.success.count";
    ...
    public ScyllaSinkCounter(String name) {
