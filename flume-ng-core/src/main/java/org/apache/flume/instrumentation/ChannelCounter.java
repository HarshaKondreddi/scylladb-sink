...
public class ChannelCounter extends MonitoredCounterGroup implements
  ...
  private static final String COUNTER_CHANNEL_ERRORS =
      "channel.errors";
  ...
  public long addToChannelErrorCount(long delta) {
    return addAndGet(COUNTER_CHANNEL_ERRORS, delta);
  }
  ...
  public long getErrorCount() {
    return get(COUNTER_CHANNEL_ERRORS);
  }
