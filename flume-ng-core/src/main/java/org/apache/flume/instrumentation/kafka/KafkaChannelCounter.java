...
public class KafkaChannelCounter extends ChannelCounter
  ...
  private static final String FAILED_EVENT_COUNT =
          "channel.failedevent.count";

  private static String[] ATTRIBUTES = {
    TIMER_KAFKA_COMMIT,TIMER_KAFKA_EVENT_SEND,TIMER_KAFKA_EVENT_GET, COUNT_ROLLBACK, FAILED_EVENT_COUNT
  };
  ...
  public long addToFailedEventsCounter(long delta) {return addAndGet(FAILED_EVENT_COUNT, delta);}
