...
public class MemoryChannel extends BasicChannelSemantics {
  ...
  protected volatile Integer transCapacity;
   ...
   * <li>byteCapacityBufferPercentage = type int that defines the percent of buffer
   * between byteCapacity and the estimated event size.
