...
public class KafkaSinkConstants {
  ...
  /* Properties */
  public static final String ASYNC_KAFKA_WORKERS = "asyncKafkaWorkers";
  public static final String TOPIC_CONFIG = KAFKA_PREFIX + "topic";
  public static final String BATCH_SIZE = "flumeBatchSize";
  public static final String BOOTSTRAP_SERVERS_CONFIG = KAFKA_PREFIX + ProducerConfig.BOOTSTRAP_SERVERS_CONFIG;

  public static final String TOPIC_HDR = "topicHeader";
  public static final String TOPIC_KEY_HDR = "topicKeyHeader";
  public static final String DEFAULT_TOPIC_HDR = "topic";
  public static final String DEFAULT_TOPIC_KEY_HDR = "key";
  ...
  public static final int DEFAULT_ASYNC_WORKERS = 8;
