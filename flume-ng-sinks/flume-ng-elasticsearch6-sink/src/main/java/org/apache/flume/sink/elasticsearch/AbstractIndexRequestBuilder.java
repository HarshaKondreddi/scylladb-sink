 ...
 * {@link ESIndexRequestBuilder}.
 */
public abstract class AbstractIndexRequestBuilder implements ESIndexRequestBuilder {
   ...
   */
  protected AbstractIndexRequestBuilder(FastDateFormat fastDateFormat) {
   ...
   */
  @Override
  public org.elasticsearch.action.index.IndexRequestBuilder createIndexRequest(
      Client client, String indexPrefix, String indexType, Event event)
      throws IOException {

    org.elasticsearch.action.index.IndexRequestBuilder request = prepareIndex(client);
  ...
  protected String getIndexName(String indexPrefix, long timestamp) {
    return indexPrefix + '-' + fastDateFormat.format(timestamp);
  }
