...
public class ElasticSearchSinkConstants {
  ...
  public static final String DEFAULT_SERIALIZER_CLASS = ElasticSearchDynamicSerializer.class.getName();
  public static final String DEFAULT_INDEX_NAME_BUILDER_CLASS = SimpleIndexNameBuilder.class.getName();
}
