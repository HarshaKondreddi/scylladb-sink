...
/**
 * Interface for creating ElasticSearch {@link org.elasticsearch.action.index.IndexRequestBuilder} instances
 * from serialized flume events. This is configurable, so any config params
 * required should be taken through this.
 */
public interface ESIndexRequestBuilder extends Configurable, ConfigurableComponent {

  FastDateFormat df = FastDateFormat.getInstance("yyyy-MM-dd", TimeZone.getTimeZone("Etc/UTC"));
   ...
   * @return prepared ElasticSearch {@link org.elasticsearch.action.index.IndexRequestBuilder} instance
