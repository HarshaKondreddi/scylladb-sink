...
public class SinkConfiguration extends ComponentConfiguration {
  ...
  public enum SinkConfigurationType {
    ...
    /**
     * JDBC Sink
     * @see org.apache.flume.sink.jdbc.JDBCSink
     */
    JDBC("org.apache.flume.sink.jdbc.JdBCSinkConfiguration"),
    ...
    /**
     * Redis Sink
     * @see org.apache.flume.sink.http.RedisSink
     */
    REDIS("org.apache.flume.sink.redis.RedisConfiguration"),

    /***
     *  SCYLLADB Sink
     * @see org.apache.flume.sink.scylladb.ScyllaDBSink
     */
    SCYLLADB("org.apache.flume.sink.scylladb.ScyllaDBConfiguration"),

    KINESIS("org.apache.flume.sink.kinesis.KinesisConfiguration");
